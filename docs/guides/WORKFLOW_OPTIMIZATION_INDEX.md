...
**File to read**: [`WORKFLOW_QUICK_REFERENCE.md`](./WORKFLOW_QUICK_REFERENCE.md)
\- Section "Add Caching"
...
1. Fix: Pin unpinned actions
1. Optimize: Add basic caching
1. Document: Create workflow guide
...
1. Make improvements to documentation
1. Submit a pull request
1. Reference this analysis in your PR description
