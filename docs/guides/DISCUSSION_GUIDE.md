...
> **Comprehensive guide for leveraging GitHub Discussions in the Ivviiviivvi
> organization**

This guide provides an exhaustive framework for using GitHub Discussions to
foster community engagement, knowledge sharing, and collaborative
problem-solving across all organization repositories.
...
1. **Choose the Right Category**: Select appropriate category
1. **Use a Clear Title**: Descriptive and searchable
1. **Follow the Template**: Use category template
1. **Add Relevant Labels**: Help others find it
1. **@mention Appropriately**: Don't over-tag
...
1. **Mark Helpful Answers**: Use the answer feature in Q&A
1. **Update the Original Post**: Add edits with new information
1. **Close When Resolved**: Mark discussions as answered/resolved
1. **Thank Contributors**: Acknowledge helpful responses
...
1. **Use Reactions**: 👍 helpful comments
1. **Link to Resources**: Share relevant documentation
1. **Quote Specifically**: Quote when replying to specific points
...
**Lock Discussion**: When conversation becomes unproductive **Convert to
Issue**: When actionable items emerge **Delete Comments**: For spam or
violations **Ban Users**: For repeated violations
...
1. Email maintainers (see SECURITY.md)
1. Tag @moderators in comments
...
1. Link back to discussion
1. Update discussion with issue link
