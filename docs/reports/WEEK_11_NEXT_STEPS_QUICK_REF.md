...
1. **Generate fine-grained PAT**:
   ...
   - Choose: theoretical-specifications-first, system-governance-framework,
...
1. **If config exists**, use GitHub's label sync feature:
...
1. **Add 5 repositories** (repos 4-8 from Week 11 plan)
1. **Test dry-run**
1. **Deploy to Phase 2** repositories
...
- **Week 11 Plan**:
  [docs/WEEK_11_DEPLOYMENT_PLAN.md](WEEK_11_DEPLOYMENT_PLAN.md)
