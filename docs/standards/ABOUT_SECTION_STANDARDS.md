...
This document defines the standards for repository "About" sections across the ivviiviivvi organization. A complete About section is essential for discoverability, professionalism, and clear communication of a repository's purpose.
...
**Examples**:
- ✅ **Good**: "Organization policies repository - Community health files, AI framework (26+ agents), and workflow automation for the ivviiviivvi organization"
- ✅ **Good**: "Python automation toolkit - Streamlines CI/CD workflows with pre-built GitHub Actions templates"
...
**Definition**: A structured, semantic title that clearly defines what the repository IS in ontological terms (its essence and classification).
...
2. **Technology/Language** (What technology stack?)
   - Python, TypeScript, React, Docker, Kubernetes, GitHub

3. **Function/Purpose** (What specific purpose?)
...
The About section metadata should be synchronized with `.schema-org/repository.jsonld`:
...
- **GitHub CLI**: `gh repo edit --description "..." --homepage "..." --topics "topic1,topic2"`
