...
Organization-wide standards for version control, branching, tagging, and release
management.
...
This document establishes organization-wide standards for version control
practices. These standards ensure consistency, traceability, and clarity across
all repositories.

### Core Principles

1. **Git History as Version Trail**: The Git commit history serves as the
   detailed version trail
1. **Semantic Versioning**: Use tags for releases following semver (v1.0.0,
   v1.0.1, v1.1.0)
1. **Descriptive Branching**: Branch names visually communicate development
   phase and purpose
1. **Conventional Commits**: Structured commit messages enable automated tooling
...
Branches follow a hierarchical naming structure that visually represents the
order and purpose of development.
...
1. **testing/** - Features in testing phase
1. **staging/** - Features ready for staging environment
1. **production/** - Production-ready features (typically merged to main)
1. **maintenance/** - Long-term maintenance branches
1. **archive/** - Archived branches for historical reference
...
Releases are automatically created based on conventional commits using
semantic-release.
...
1. CHANGELOG.md is automatically generated
1. Git tag is created
1. GitHub Release is published
1. Packages are published (if configured)
...
The Git commit history is the authoritative record of all changes. Each commit
represents a discrete change with:
...
The complete version trail includes both the commit messages and the actual code
changes (diffs) in the Git history.
