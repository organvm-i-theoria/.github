...
- [Configuration Guide](getting-started/CONFIGURATION.md) - Variables and
  secrets
- [Customization Guide](getting-started/CUSTOMIZATION.md) - Branding and
  modifications
...
- [Ecosystem Architecture](architecture/AUTONOMOUS_ECOSYSTEM_ARCHITECTURE.md) -
  Full architecture
...
- [Repository Setup Checklist](runbooks/REPOSITORY_SETUP_CHECKLIST.md) - New
  repo setup
...
[Contributing Guide](governance/CONTRIBUTING.md) to get started.
