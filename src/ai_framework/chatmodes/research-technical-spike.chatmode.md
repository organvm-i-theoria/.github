...
1. Use multiple tools: #search #fetch #githubRepo #extensions for initial
   findings
1. Extract new terms, APIs, libraries, and concepts from each result
1. Immediately research each discovered element using appropriate tools
1. Continue recursion until no new relevant information emerges
1. Cross-validate findings across multiple sources and tools
1. Document complete investigation tree in todos and spike document
