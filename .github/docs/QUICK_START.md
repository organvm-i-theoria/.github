...
Welcome! This guide will help you create your first automated application walkthrough video in just 5 minutes.

## Getting Started in 5 Minutes

### Step 1: Navigate to Your Repository
1. Go to your repository on GitHub (e.g., `github.com/ivviiviivvi/your-repo-name`)
2. Make sure your application has a working local development setup

### Step 2: Go to the Actions Tab
1. Click the **Actions** tab at the top of your repository
2. Look for "Generate Application Walkthrough" in the workflow list
3. Click on the workflow name

### Step 3: Select the Workflow
1. On the right side, click the **"Run workflow"** dropdown button
2. Select your branch (usually `main` or `develop`)
...
2. The page will refresh - click on your workflow run to see progress
...
3. Click **"walkthrough-video"** to download (ZIP file)
4. Extract the ZIP to get `walkthrough-video.mp4`
...
**What you'll get**: Polished, business-focused walkthrough highlighting core functionality and benefits.
...
**What you'll get**: Friendly, approachable explanation of how the application works and where things are located.
...
**What you'll get**: Technical walkthrough focusing on implementation details, architecture, and code structure.
...
2. Verify dependencies are installed (`package.json`, `requirements.txt`)
3. Ensure environment variables are documented
4. Check if your app requires a database or external service
...
3. Open `walkthrough-video.mp4` in any video player
4. Review the video before sharing with others
...
**Advanced**: For apps with multiple services, focus on one service per walkthrough or configure a proxy.

### Q: How long are videos stored?
**A**: Workflow artifacts are retained for **90 days** by default (GitHub's standard retention period).

**Best practice**: Download and archive important walkthroughs in your own storage or video platform.

### Q: Can I customize the video resolution?
**A**: Currently, videos are generated at **1920x1080 (Full HD)**. This works well for:
- YouTube uploads
...
2. Adjust the duration (longer = more coverage)
3. Break into multiple focused walkthroughs
4. Review logs to see what was captured
...
*Note: Example videos are for demonstration purposes and may not always be available.*
...
2. 📝 Review example configurations for your app type
3. ⚙️ Set up scheduled automated walkthroughs
4. 🤝 Share your walkthroughs with the community
...
*Last updated: 2025-12-21 | Version: 1.0.0 | Maintained by @4444JPP*
